...
impl Repository for GamePgRepo {
  ...
  async fn get_by_id(&self, id: Uuid) -> Result<Self::Data, RepositoryError<NotFound, Self::ClientError>> {
    todo!()
  }

  async fn create(&self, value: Self::Data) -> Result<Self::Data, RepositoryError<AlreadyExists, Self::ClientError>> {
    todo!()
  }

  async fn update(&self, value: Self::Data) -> Result<Self::Data, RepositoryError<NotFound, Self::ClientError>> {
    todo!()
  }
...
impl<'pool> PgRepo for GamePgRepo {
